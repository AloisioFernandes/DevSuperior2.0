...
dayjs.locale('pt-br') //configurações iniciais dayjs
...
function dateFromNow(date: string) { //função para formatar horário com dayjs
  return dayjs(date).fromNow() //retorna quantidade de tempo entre momento inicial e momento presente
}
